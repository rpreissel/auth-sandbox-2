...
export async function registerRoutes(app: any) {
  ...
  app.get('/api/observability/traces', async (request: FastifyRequest) => {
    const query = observabilityTraceListSchema.parse(request.query)
    return listTraces(query)
  })

  app.get('/api/observability/traces/:traceId', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.get('/api/observability/spans/:spanId', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.get('/api/observability/artifacts/:artifactId', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post('/api/observability/client-events', async (request: FastifyRequest, reply: FastifyReply) => {
