import type { MockApiAssuranceLevel } from '@auth-sandbox-2/shared-types'
...
export function buildAuthorizationUrl(input: {
  ...
  url.searchParams.set('scope', 'openid profile email mock-api-access')
...
export function satisfiesAssuranceLevel(acr: string | null, requiredLevel: MockApiAssuranceLevel) {
...
export function getMockApiAccessLabel(acr: string | null) {
  if (acr === '2se') {
