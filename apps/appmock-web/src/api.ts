...
export const api = {
  ...
  deleteDeviceConflict: (id: string, options?: TraceRequestOptions) => requestJson<void>(API_BASE, `/api/device/conflicts/${id}`, { method: 'DELETE', body: JSON.stringify({}) }, options),
