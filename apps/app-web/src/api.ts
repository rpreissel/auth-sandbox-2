...
export const api = {
  createFlow: (body: CreateFlowInput, options?: TraceRequestOptions) => requestJson<CreateFlowResponse>(API_BASE, '/api/flows', { method: 'POST', body: JSON.stringify(body) }, options),
