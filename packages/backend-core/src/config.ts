...
const envSchema = z.object({
  ...
  AUTH_API_DEVICE_HANDOVER_DERIVATION_SECRET: z.string().min(16).default('change-me-device-handover-derivation-secret'),
...
export const appConfig = {
  ...
  deviceHandoverDerivationSecret: env.AUTH_API_DEVICE_HANDOVER_DERIVATION_SECRET,
